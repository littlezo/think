 ...
 *
 */
namespace littler\library\client;
...
class Response implements \ArrayAccess
{
    ...
    /**
     * @return null|bool|callable|float|\GuzzleHttp\Psr7\PumpStream|\GuzzleHttp\Psr7\Stream|int|\Iterator|\Psr\Http\Message\StreamInterface|resource|string
     */
